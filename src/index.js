      ...
      <section class="panel ${safe(config.default_size || "standard")}" aria-label="Chat with ${safe(config.name)}">
        <header class="head">
          ...
          <div class="head-tools">
            <button class="head-control history-trigger" type="button" title="Chat History" aria-label="Chat History"><svg viewBox="0 0 24 24" aria-hidden="true"><path d="M5 8h14M5 16h14"/><ellipse cx="5" cy="12" rx="1.6" ry="4.4"/><ellipse cx="19" cy="12" rx="1.6" ry="4.4"/></svg></button>
