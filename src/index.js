...
function referenceFooter() {
  return html`<footer class="reference-footer"><div class="video-container"><div class="reference-footer-grid"><div><a class="video-logo" href="/">${referenceLogo()}</a><p class="reference-footer-summary">Helpful AI website assistants built around your business, your customers and your brand.</p></div><div><h3>Product</h3><a href="/#features">Features</a><a href="/#clients">Our Clients</a><a href="/#demo">Demo</a><a href="/#pricing">Pricing</a><a href="/#how-it-works">How it works</a></div><div><h3>Company</h3><a href="/about">About</a><a href="/blog">Blog</a><a href="/contact">Careers</a><a href="/contact">Contact</a></div></div><div class="reference-footer-bottom"><span>© 2026 Fise AI. All rights reserved.</span><span class="footer-legal-links"><a href="/privacy-policy" target="_blank" rel="noopener">Privacy Policy</a><span>·</span><a href="/terms-and-conditions" target="_blank" rel="noopener">T&amp;C's</a><span>·</span><a href="/cookies" target="_blank" rel="noopener">Cookies</a></span><span>Built for businesses that care about every conversation.</span></div></div></footer>`;
}
